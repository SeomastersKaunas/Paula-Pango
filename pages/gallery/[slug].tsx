  ...
  return (
    <>
      <Head>
        ...
        <link rel='canonical' href={`https://www.paulapango.com/gallery/${artwork.slug}`} />
        <script
        ...
        {related.length > 0 && (
          <section className='mt-24'>
            ...
            <div className='flex flex-wrap justify-center gap-5'>
              {related.map((rel) => (
                <Link key={rel.id} href={`/gallery/${rel.slug}`} className='group block w-[calc(50%-10px)] md:w-[calc(25%-15px)]'>
                  {/* Fixed square crop so all cards are the same height */}
