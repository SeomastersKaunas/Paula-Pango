...
export default function GalerijaLt() {
  return (
    <>
      <Head>
        <title>Galerija — Paula Pango</title>
        <meta name='description' content='Naršykite originalius aliejinės tapybos kūrinius. Kiekvienas paveikslas yra unikalus ir įsigyjamas.' />
        <link rel='canonical' href='https://www.paulapango.com/lt/galerija' />
        <link rel='alternate' hrefLang='en' href='https://www.paulapango.com/gallery' />
        <link rel='alternate' hrefLang='lt-LT' href='https://www.paulapango.com/lt/galerija' />
      </Head>
      ...
      <div className='max-w-6xl mx-auto px-6 py-16'>
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5'>
          {artworks.map((artwork) => (
            <Link key={artwork.id} href={`/lt/galerija/${artwork.slugLt}`} className='group block'>
