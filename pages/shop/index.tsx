...
export default function Shop() {
  ...
  return (
    <>
      <Head>
        <title>Shop — Paula Pango</title>
        <meta name='description' content='Browse and purchase original oil paintings by Paula Pango. Each piece is unique and available for purchase.' />
        <link rel='canonical' href='https://www.paulapango.com/shop' />
        ...
        <meta property='og:title' content='Shop — Paula Pango' />
